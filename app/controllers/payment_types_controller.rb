class PaymentTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_type.save
        format.html { redirect_to payment_types_url, notice: 'Payment type was successfully created.' }
  ...
  private
    ...
    def payment_type_params
      params.require(:payment_type).permit(:name, :body, :users, :email_count, :email_book, :email_templates, :sender_email)
    end
end
